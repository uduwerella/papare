            ...
            <div id="sidebar" class="sidebar">
                ...
                <div data-scrollbar="true" data-height="100%">
                    ...
                    <ul class="nav">
                        ...
                        <li class="active"><a href="data_player"><i class="ion-person-stalker bg-green"></i> <span>Manage players</span></a></li>
                        <li><a href="data_team"><i class="ion-qr-scanner bg-pink"></i> <span>Manage teams</span></a></li>
                        <li><a href="data_mapping"><i class="ion-network bg-blue"></i> <span>Player mapping</span></a></li>
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <textarea class="form-control" placeholder="Textarea" rows="5" style="max-width: 100%"></textarea>
                                        </div>
                                    </div>
                                </form>
                            </div>
